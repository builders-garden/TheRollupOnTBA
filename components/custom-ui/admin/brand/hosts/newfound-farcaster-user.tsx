    ...
    <motion.div
      ...
      <div className="flex justify-start items-center gap-2.5">
        {farcasterUser.pfp_url ? (
          ...
          <div className="size-10 rounded-full bg-muted/20 flex justify-center items-center">
      ...
      <CTSButton
        ...
        className="h-[42px] w-[20%] shrink-0 gap-1.5">
        <AnimatePresence mode="wait">
          {isCreatingFromThisUser ? (
            ...
            <motion.div
              ...
              <p className="text-sm text-background font-extrabold">Add Host</p>
            </motion.div>
          )}
        </AnimatePresence>
      </CTSButton>

...
export const MiniAppCustomTipModal = ({
  customTipButton,
  isProcessing,
  isTransferLoading,
  handleTipPayment,
  brandSlug,
}: MiniAppCustomTipModalProps) => {
    ...
    <CTSModal
      ...
      <div className="flex flex-col justify-center items-center w-full gap-1">
        ...
        <p className="text-sm text-muted-foreground text-center">
          Add a custom message by tipping {MIN_TIP_AMOUNT_FOR_CUSTOM_MESSAGE}$
          or more
        </p>
      </div>
      ...
      <div className="flex flex-col justify-center items-center w-full gap-2.5 my-2.5">
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            <div
              className={cn(
                "flex justify-center items-center w-full gap-1 rounded-[12px] pl-2 border-muted border-[1px] ring-muted-foreground/40 transition-all duration-300",
                brandSlug === THE_ROLLUP_BRAND_SLUG &&
                  "border-accent ring-accent/40",
              ...
              <p className="text-xs text-muted-foreground ml-3 mr-1.5">

...
export async function getFarcasterManifest() {
  let miniappName = "Farcaster Starter";
  let noindex = true;
  ...
  return {
    ...
    miniapp: {
      ...
      subtitle: "Farcaster Mini-app Starter", // 30 characters, no emojis or special characters, short description under app name
      description: "Farcaster Mini-app Starter", // 170 characters, no emojis or special characters, promotional message displayed on Mini App Page
      primaryCategory: "social", // https://github.com/farcasterxyz/miniapps/blob/main/packages/miniapp-core/src/schemas/manifest.ts
      tags: ["farcaster", "mini-app", "starter"], // up to 5 tags, filtering/search tags
      tagline: "Farcaster Mini-app Starter", // 30 characters, marketing tagline should be punchy and descriptive
      ogTitle: `${miniappName}`, // 30 characters, app name + short tag, Title case, no emojis
      ogDescription: "Farcaster Mini-app Starter", // 100 characters, summarize core benefits in 1-2 lines
      screenshotUrls: [
